...
namespace bzn
{
    ...
    TEST_F(raft_test, test_that_leader_sends_entries_and_commits_when_enough_peers_have_saved_them)
    {
        ...
        ASSERT_FALSE(raft->append_log(bzn::message(), bzn::log_entry_type::log_entry));
        ...
        msg["bzn-api"] = "crud";
        msg["data"] = "utests_1";
        ASSERT_TRUE(raft->append_log(msg, bzn::log_entry_type::log_entry));
        msg["data"] = "utests_2";
        ASSERT_TRUE(raft->append_log(msg, bzn::log_entry_type::log_entry));
    ...
    TEST(raft, test_that_raft_can_rehydrate_storage)
    {
        ...
        while (storage_source->get_keys(TEST_NODE_UUID).size() < number_of_entries)
        {
            ...
            if (command <= 3)
            {
                ...
                raft_source->append_log(message, bzn::log_entry_type::log_entry);
